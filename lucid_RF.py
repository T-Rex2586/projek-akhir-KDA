...
def main(argv):
    ...
    if args.train is not None:
        ...
        for full_path in subfolders:
            ...
            dataset_folder = full_path + os.sep
            ...
            joblib.dump(best_model, best_model_filename + '.joblib')
    ...
    if args.predict is not None:
        ...
        if args.model is not None:
            ...
            model_list = glob.glob(args.predict + "/*.joblib")
        ...
        for model_path in model_list:
            ...
            filename = os.path.basename(warm_up_file).strip()
    ...
    if args.predict_live is not None:
        ...
        if args.model is not None and args.model.endswith('.joblib'):
